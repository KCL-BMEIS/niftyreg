...
int main(int argc, char **argv)
{
   ...
   mat44 affine_transformation;
   reg_mat44_eye(&affine_transformation);
   affine_transformation.m[0][0]=+0.9f;
   affine_transformation.m[0][3]=+10.f;
   affine_transformation.m[1][1]=+1.1f;
   affine_transformation.m[1][3]=-10.f;
   ...
   case 2:
      ...
      break;
   case 3:
      f3d = new reg_f3d_sym<float>(1,1);
      break;
   case 4:
      f3d = new reg_f3d2<float>(1,1);
      break;
   }
