...
int main(int argc, char **argv) {
	...
	initialise_block_matching_method(referenceImage, &blockMatchingParams, 50, 50, 1, mask, false // GPU is not used here
			);
	block_matching_method(referenceImage, warpedImage, &blockMatchingParams, mask);
