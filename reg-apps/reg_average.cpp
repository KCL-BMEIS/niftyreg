        ...
        if(operation==1){
            ...
            for(size_t i=5, j=0;i<argc;i+=2,++j){
                ...
                if(floatingImage->datatype!=tempImage->datatype){
                    ...
                    case NIFTI_TYPE_FLOAT32:reg_tools_changeDatatype<float>(floatingImage);break;
                    case NIFTI_TYPE_FLOAT64:reg_tools_changeDatatype<double>(floatingImage);break;
                    }
                }
