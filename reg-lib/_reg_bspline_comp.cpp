...
/* *************************************************************** */
template <class ImageTYPE>
double reg_bspline_GetJacobianGradient_3D(  nifti_image *velocityFieldImage,
...
/* *************************************************************** */
template <class ImageTYPE>
double reg_bspline_GetApproxJacobianGradient_3D(nifti_image *velocityFieldImage,
                                                nifti_image *gradientImage,
                                                float weight)
{
#if _USE_SSE
