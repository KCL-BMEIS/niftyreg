...
public:
    ...
    void SetReferenceBinNumber(int b, int t){this->referenceBinNumber[t]=b;}
    void SetFloatingBinNumber(int b, int t){this->floatingBinNumber[t]=b;}
    unsigned short *GetReferenceBinNumber(){return this->referenceBinNumber;}
    unsigned short *GetFloatingBinNumber(){return this->floatingBinNumber;}
