...
CLAffineDeformationFieldKernel::CLAffineDeformationFieldKernel(GlobalContent *conIn, std::string nameIn) :
    ...
    //get cpu ptrs
    this->deformationFieldImage = con->GlobalContent::getCurrentDeformationField();
