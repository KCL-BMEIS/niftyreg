...
void ClAladinContent::allocateClPtrs()
{
	...
	if (this->CurrentFloating != NULL)
	{
		...
		this->sContext->checkErrNum(this->errNum, "ClAladinContent::allocateClPtrs failed to allocate memory (floMatClmem): ");
	...
	if (this->CurrentReference != NULL)
	{
		...
		this->sContext->checkErrNum(this->errNum, "ClAladinContent::allocateClPtrs failed to allocate memory (referenceImageClmem): ");
		...
		this->sContext->checkErrNum(this->errNum, "ClAladinContent::allocateClPtrs failed to allocate memory (refMatClmem): ");
		free(targetMat);
	}
	if (this->blockMatchingParams != NULL) {
        if (this->blockMatchingParams->referencePosition != NULL) {
            ...
            this->sContext->checkErrNum(this->errNum, "ClAladinContent::allocateClPtrs failed to allocate memory (referencePositionClmem): ");
        }
        if (this->blockMatchingParams->warpedPosition != NULL) {
            ...
            this->sContext->checkErrNum(this->errNum, "ClAladinContent::allocateClPtrs failed to allocate memory (warpedPositionClmem): ");
        }
        if (this->blockMatchingParams->totalBlock != NULL) {
            ...
            this->sContext->checkErrNum(this->errNum, "ClAladinContent::allocateClPtrs failed to allocate memory (activeBlockClmem): ");
        }
	}
	if (this->CurrentReferenceMask != NULL) {
		...
		this->sContext->checkErrNum(this->errNum, "ClAladinContent::allocateClPtrs failed to allocate memory (clCreateBuffer): ");
	}
}
/* *************************************************************** */
